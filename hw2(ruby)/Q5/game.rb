...
class Game < Gosu::Window
  ...
  def initialize
    ...
    @plumber = ActiveCharacter.new("plumber",
                                   ...
                                   [])
    @dragon  = VillanCharacter.new("dragon",
                             200,
                             {name:"fireball", hit:20},
                             ["images/dragon2-1.png","images/dragon2-2.png"])
    @princess = HeroineCharacter.new("princess",
                              10000,
  ...
  def draw
    if  @end_game == false
      ...
      if @plumber.has?("ruby") and @dragon.dead? 
        mangalam=<<-END
                Wow! you are awesome. You got precious ruby for me!!
                Let's dance!!
                END
...
class VillanCharacter < Character
...
class HeroineCharacter < Character
  def initialize (name,health,img)
    super name,health,img
  end
end
